...
def test_criar_usuario():
    usuario = Usuario(nome="João Silva", email="joao@test.com", senha="senha123")
...
def test_criar_voo():
    ...
    voo = Voo(nome="AA123", data_partida=data_partida, data_chegada=data_chegada)
...
def test_criar_passagem():
    ...
    passagem = Passagem(
        numero="PASS123", valor=500.0, data=date.today(), passageiro=passageiro, voo=voo
    )
