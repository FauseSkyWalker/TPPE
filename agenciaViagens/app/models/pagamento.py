...
class Pagamento(BaseModel):
    ...
    aluguel_carro = relationship(
        "AluguelCarro", back_populates="pagamento", uselist=False
    )
    aluguel_hotel = relationship(
        "AluguelHotel", back_populates="pagamento", uselist=False
    )
