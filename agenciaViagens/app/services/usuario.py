...
from ..repositories import UsuarioRepository, PessoaFisicaRepository, PessoaJuridicaRepository
from ..schemas import (
    UsuarioCreate, PessoaFisicaCreate, PessoaJuridicaCreate,
...
class UsuarioService:
    ...
    async def criar_pessoa_fisica(self, pessoa_fisica: PessoaFisicaCreate) -> PessoaFisica:
    ...
    async def criar_pessoa_juridica(self, pessoa_juridica: PessoaJuridicaCreate) -> PessoaJuridica:
        # Verificar se email já existe
